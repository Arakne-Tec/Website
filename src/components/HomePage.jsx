...
function HomePage() {
        ...
        reviews: [
          {
            name: 'أحمد محمد',
            role: 'منظم فعاليات',
            content: 'أراكني جعلت تنظيم فعالياتي أسهل بكثير. المعدات عالية الجودة والخدمة ممتازة.',
            rating: 5
          },
          {
            name: 'فاطمة العلي',
            role: 'صاحبة مطعم',
            content: 'استأجرت معدات تقديم الطعام لحفل زفاف. كل شيء كان مثالياً والأسعار معقولة.',
            rating: 5
          },
          {
            name: 'خالد السعد',
            role: 'مدرب رياضي',
            content: 'أحصل على معدات اللياقة البدنية من أراكني بانتظام. الجودة والخدمة لا تُضاهى.',
            rating: 5
          }
        ]
      },
        ...
        reviews: [
          {
            ...
            content: 'Arakne made organizing my events so much easier. High-quality equipment and excellent service.',
            rating: 5
          },
          {
            name: 'Fatima Al-Ali',
            role: 'Restaurant Owner',
            content: 'Rented catering equipment for a wedding. Everything was perfect and reasonably priced.',
            rating: 5
          },
          {
            name: 'Khalid Al-Saad',
            role: 'Fitness Trainer',
            content: 'I regularly get fitness equipment from Arakne. The quality and service are unmatched.',
            rating: 5
          }
        ]
      },
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#f5f1eb', color: '#2c2c2c', direction: isArabic ? 'rtl' : 'ltr' }}>
      {/* Header */}
      <header className="py-4" style={{ backgroundColor: '#2c2c2c' }}>
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="#categories" className="text-white hover:opacity-70 transition-opacity">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="space-y-2 opacity-80">
                ...
                <Link to="/privacy" className="block hover:opacity-70 transition-opacity">
                  {currentContent.footer.links.privacy}
                </Link>
                <Link to="/terms" className="block hover:opacity-70 transition-opacity">
