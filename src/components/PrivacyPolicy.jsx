        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>That is about you but individually does not identify you, such as geographic location information, device type, operating system, application usage information.</li>
            ...
            <ul className="list-disc pl-6 mb-4">
              <li><strong>Profile Picture Uploads:</strong> To allow you to capture a photo directly for use as your profile picture within the application.</li>
              <li><strong>Product/Equipment Photo Uploads:</strong> To enable lessors to capture photos of equipment they wish to list for rent and upload them directly to their product listings.</li>
            ...
            <p className="mb-4">
              Our Platform may allow you to upload or post photos, videos, or other media as part of User Contributions, such as product reviews, comments, or reporting issues related to rented items (e.g., defective or damaged items). When you submit such content, you agree that these photos or media may be collected, stored, and displayed by us, and may be visible to other users or the public, depending on the privacy settings of the feature you are using. We use this content to improve our services, address complaints, display reviews, and verify the accuracy of information provided. You are responsible for ensuring that any content you submit adheres to our Terms of Use and does not infringe upon the rights of any third party. All user-submitted photos and media are handled in accordance with this Privacy Policy and our data security standards.
            </p>
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li><strong>Promoting Lessors and Advertisements:</strong> We may use your location data to provide personalized advertisements and promotions from nearby lessors, aiming to enhance your experience on the Platform and provide you with relevant services.</li>
            </ul>
            ...
            <div className="mb-6">
              ...
              <p className="mb-1">[Support Phone Number]</p>
